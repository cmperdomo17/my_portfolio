...
const Contact = () => {
    ...
    return (
        <section className={`flex justify-center flex-col h-full pt-40 md:pt-28 pb-10 md:pb-28 ${darkMode ? 'bg-gradient-to-b from-slate-950 to-slate-900' : 'bg-gradient-to-b from-slate-200 to-slate-100'}`}>
